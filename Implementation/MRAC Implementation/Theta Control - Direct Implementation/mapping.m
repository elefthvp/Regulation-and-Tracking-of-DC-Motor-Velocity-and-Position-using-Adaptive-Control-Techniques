function [theta1star,theta2star, theta3star] = mapping(Wm,Gp,n,Lamda,km,kp)
...
% theta2 = solve
theta1star = double(strct.theta1)
theta2star = double(strct.theta2)
theta3star = double(strct.theta3)
end
